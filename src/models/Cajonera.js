...
class Cajonera extends THREE.Object3D
{
	...
	})
	{
		...
		//cajoneraGeometry.translate(this.ancho/2,this.alto/2,this.fondo/2)
		let cajonera = new THREE.Mesh(cajoneraGeometry,this.cajonMaterial)
		...
		//cajaTempGeometry.translate(0,() ,this.borde)

		cajaTempGeometry.translate(0,this.altoCara/2,this.borde/2)
		cajaTempGeometry.translate(0,this.borde,0)

	//	this.add(new THREE.Mesh(cajaTempGeometry,this.cajonMaterial))
	...
	createCajon() {
		...
		let suelo = new THREE.Mesh(sueloGeometry,new THREE.MeshBasicMaterial({color: 0x298389}))
		...
		let caraDelantera = new THREE.Mesh(caraDelanteraGeometry,this.cajonMaterial)
		...
		let caraTrasera = new THREE.Mesh(caraTraseraGeometry,this.cajonMaterial)
		...
		let paredIzq = new THREE.Mesh(paredIzqGeometry,this.cajonMaterial)
		...
		let paredDcha = new THREE.Mesh(paredDchaGeometry,this.cajonMaterial)
	...
	createAsa() {
		...
		let asaFrontal = new THREE.Mesh(asaFrontalGeometry,this.cajonMaterial);
		...
		let asaIzq = new THREE.Mesh(asaIzqGeometry,this.cajonMaterial);
		...
		let asaDcha = new THREE.Mesh(asaDchaGeometry,this.cajonMaterial);
